      ...
      <div className="flex items-center gap-2.5">
        ...
        {onToggleCurrency && (
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1 text-xs font-bold text-slate-700 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg transition-colors"
        ...
        {onOpenPitchGuide && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-900 bg-amber-50 hover:bg-amber-100 border border-amber-300 rounded-lg transition-colors shadow-2xs"
          >
            <BookOpen className="w-3.5 h-3.5 text-amber-600" />
            <span className="hidden sm:inline">PS #13 Solution Guide</span>
          </button>
        )}
        ...
        >
          ...
          <span className="hidden md:inline">Sync Engine</span>
        </button>

        {/* Live Sentinel Badge */}
        <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 text-xs font-bold text-emerald-800 bg-emerald-50 border border-emerald-200 rounded-lg">
          <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
          <span className="hidden md:inline">Deterministic Math Sentinel Active</span>
        </div>
      </div>
    </header>
  );
